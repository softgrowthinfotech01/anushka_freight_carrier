  ...
  <div class="sheet" role="document" aria-label="Consignment note">
    ...
    <header>
      <div class="logo" aria-hidden="true">
        ...
        <div>
          <div style="font-size:18px">AFC</div>
          <div style="font-size:9px;margin-top:3px">FRIEGHT</div>
        </div>
      </div>
      ...
      <div class="right-head">
        <div class="non-neg">NON-NEGOTIABLE &nbsp; CONSIGNMENT NOTE</div>
        <!-- <div class="muted">PAN No. ALGPV0809D</div> -->
        <div style="margin-top:10px">
          <div class="cons-no" aria-label="Consignment number">....</div>
        </div>
      </div>
    </header>
      ...
      <div class="form-left" role="form">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="field">[Name, Address, Phone]</div>
          </div>
          <div class="col">
        ...
        <div class="table-like">
          ...
          <div class="small-grid" aria-hidden="false" role="group" aria-label="Packing and weight grid">
            <div class="cell"><strong>No. Of Packages</strong>
              <div style="margin-top:6px;" class="tiny">0</div>
            </div>
            <div class="cell"><strong>Method of Packing</strong>
              <div style="margin-top:6px;" class="tiny">—</div>
            </div>
            <div class="cell"><strong>HSN Code</strong>
              <div style="margin-top:6px;" class="tiny">—</div>
            </div>
            <div class="cell"><strong>Classification of Goods Code</strong>
              <div style="margin-top:6px;" class="tiny">—</div>
            </div>
            <div class="cell"><strong>Actual Wt. in Kgs.</strong>
              <div style="margin-top:6px;" class="tiny">—</div>
            </div>
            <div class="cell"><strong>Charged wt. in Kgs./category of Load</strong>
              <div style="margin-top:6px;" class="tiny">—</div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;">
            <div style="flex:1;">
              ...
              <div class="field">[Description of contents]</div>
            </div>
            <div style="width:220px">
              <label>Distance</label>
              <div class="field-distance" style="height: 20px;">Kms: ——</div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;">
            <div style="flex:1;">
              <div class="field">
                <label>Private Marks / Other Identification:</label><br><br>
              <label>Business Type:</label></div>
            </div>
            <div style="width:220px">
              <label>For Paid Consignment </label>
              <div class="field">
                <label>M.R. No :</label>
              <label>Date :</label>
            <label>Amount :</label>
          ...
          <div class="dim-table" style="margin-bottom:8px;">
            ...
            <div class="box">No. of Pkgs</div>
            <div class="box">Total CFT/CMT</div>
            <div class="box">Single piece weight</div>
          </div>
